...
2. Experiência: Pode reescrever e distribuir as atividades usando marcadores (bullet points) para otimizar a leitura, mas é expressamente proibido inventar tarefas, instituições ou localizações que não estejam no texto original. Deve reter 100% dos substantivos técnicos específicos (ex: 'blindadoras', 'concessionárias', anel o-ring, etc) e transcrever os endereços físicos de forma integral. Use quebra de linha ("\\n") para separar os marcadores.
